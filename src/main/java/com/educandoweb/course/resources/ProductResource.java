...
@RequestMapping(value = "/products") 			 // ANOTAÇÃO QUE DA O NOME AO RECURSO QUE TBM É O CAMINHO /users
public class ProductResource {
	...
	public ResponseEntity<List<Product>> findAll(){   // METODO QUE RETORNA RESPOSTAS DE REQUISIÇÕES WEB / COM O TIPO DA CLASSE
		List<Product> list = service.findAll();       // AGORA USAREMOS O METODO DO USERRESOURCE
	...
	public ResponseEntity<Product> findById(@PathVariable Long id){  // AI ELE RECEBE O PARAMETRO LONG ID, E A ANOTAÇÃO @PATHVARIABLE PRA SER ACEITO COMO PARAMETRO
